...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return new AboutPage(getActivity())
                ...
                .addEmail("atendimendo@atmconsultoria.com.br", "Envie um e-mail")
                .addWebsite("https://www.google.com", "Acesse nosso site")

                .addGroup("Redes sociais")
                .addFacebook("CaioDetore", "Facebook")
                .addInstagram("CaioDetore", "Instagram")
                .addTwitter("CaioDetore", "Twitter")
                .addYoutube("CaioDetore", "Youtube")
                .addGitHub("CaioDetore", "GitHub")
